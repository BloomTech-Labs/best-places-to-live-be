...
describe('insert', () => {
  ...
  beforeAll(async () => {
    connection = await MongoClient.connect(
      `mongodb+srv://${process.env.TESTING_MONGO_USERNAME}:${process.env.TESTING_MONGO_PASSWORD}@${process.env.TESTING_MONGO_HOSTNAME}/${process.env.TESTING_MONGO_DB}?retryWrites=true&w=majority`,
      {
